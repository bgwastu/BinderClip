...
enum E2ECrypto {
    ...
    private static let aad = Data("clipboard-v2".utf8)
    ...
    static func deriveKey(secretBytes: Data) -> SymmetricKey? {
        ...
        return HKDF<SHA256>.deriveKey(
            ...
            info: Data("clipboard-enc-v1".utf8),
            outputByteCount: 32
        )
    }
    ...
    static func deviceTag(secretBytes: Data) -> Data? {
        ...
        let tagKey = HKDF<SHA256>.deriveKey(
            inputKeyMaterial: ikm,
            info: Data("clipboard-tag-v1".utf8),
            outputByteCount: 8
        )
    ...
    static func ecdhSharedSecret(
        ...
        let key = shared.hkdfDerivedSymmetricKey(
            using: SHA256.self,
            salt: Data(),
            sharedInfo: Data("clipboard-ecdh-v1".utf8),
            outputByteCount: 32
        )
    ...
    static func deriveAuthKey(secretBytes: Data) -> SymmetricKey? {
        ...
        return HKDF<SHA256>.deriveKey(
            inputKeyMaterial: ikm,
            info: Data("clipboard-auth-v2".utf8),
            outputByteCount: 32
        )
    }
    ...
    static func deriveSessionKey(secretBytes: Data, ecdhResult: Data) -> SymmetricKey? {
        ...
        return HKDF<SHA256>.deriveKey(
            ...
            info: Data("clipboard-session-v2".utf8),
            outputByteCount: 32
        )
    }
