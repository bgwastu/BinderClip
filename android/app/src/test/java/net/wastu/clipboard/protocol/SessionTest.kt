...
class SessionTest {
    ...
    fun `pairing followed by v2 handshake and clipboard transfer succeeds`() {
        ...
        // 3. Send KEY_CONFIRM (encrypted "clipboard-paired")
        val encKey = E2ECrypto.deriveKey(sharedSecret)
        val confirmPayload = E2ECrypto.seal("clipboard-paired".toByteArray(), encKey)
    ...
    private fun loadImageTransferFixture(): JSONObject {
        val path = "macos/test-fixtures/protocol/l2cap/image_transfer_fixture.json"
