package net.wastu.clipboard.protocol
...
import net.wastu.clipboard.tcp.NetworkUtil
import net.wastu.clipboard.tcp.TcpImageReceiver
import net.wastu.clipboard.tcp.TcpImageSender
import net.wastu.clipboard.tcp.TcpTransferException
...
class Session(
    ...
    private fun pairingResponderHandshake(pairing: SessionMode.Pairing) {
        ...
        val expected = "clipboard-paired".toByteArray()
