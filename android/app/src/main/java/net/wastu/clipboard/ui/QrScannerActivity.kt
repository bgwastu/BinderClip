...
import net.wastu.clipboard.pairing.PairingUriParser
...
class QrScannerActivity : AppCompatActivity() {
    ...
    private fun handleScannedValue(rawValue: String?) {
        ...
        val prefs = getSharedPreferences(ClipboardService.PREFS_NAME, MODE_PRIVATE)
        prefs.edit()
        ...
        intent.action = ClipboardService.ACTION_START_PAIRING
        if (!BlePermissions.hasRequiredRuntimePermissions(this) ||
