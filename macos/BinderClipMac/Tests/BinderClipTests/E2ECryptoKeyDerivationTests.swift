...
final class E2ECryptoKeyDerivationTests: XCTestCase {
    ...
    private let rawEcdhSecretHex = "fcd54dacce529f89bb4a3d48a3f68da3093ec379b84e16d0d03cdf80a8cb6238"
    private let expectedRootSecretHex = "753c3067d7ed56384ace75c07da61e6d547c4fc82e0ca0b1082c9cbda42fc853"
    private let expectedEncryptionKeyHex = "3edc21d3c7f029b51fcf5163d7a23dee1b9926e20fee20ab49f43376442488f2"
    private let expectedDeviceTagHex = "020e73f5b1906642"
    private let expectedPairingTagHex = "82dab32a9aedffb4"
    private let macPublicKeyHex = "132c442be010fbd57e72603328aa76e71fccc1503aae219327d14d9c9993f472"

    func testECDHFixtureRootSecret() {
        // root_secret = HKDF-SHA256(ikm=raw_ecdh_secret, salt=empty, info="clipboard-ecdh-v1", len=32)
        ...
        let rootKey = HKDF<SHA256>.deriveKey(
            ...
            info: Data("clipboard-ecdh-v1".utf8),
            outputByteCount: 32
        )
...
private enum V2SessionFixtureLoader {
    static func load() throws -> V2SessionFixture {
        let relativePath = "macos/test-fixtures/protocol/l2cap/v2_session_fixture.json"
