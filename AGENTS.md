...
- Android background help may request the standard battery-optimization allowlist and open App Info for OEM Auto Start controls. Do not add private manufacturer setting intents: Android provides no portable or trustworthy Auto Start API.
