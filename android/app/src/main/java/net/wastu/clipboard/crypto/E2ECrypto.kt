...
object E2ECrypto {
    ...
    private val AAD = "clipboard-v2".toByteArray(Charsets.UTF_8)

    fun deriveKey(secretBytes: ByteArray): SecretKey {
        val keyBytes = hkdf(secretBytes, "clipboard-enc-v1", 32)
    ...
    fun deviceTag(secretBytes: ByteArray): ByteArray {
        return hkdf(secretBytes, "clipboard-tag-v1", 8)
    }
