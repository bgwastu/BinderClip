...
final class Session {
    private let logger = Logger(subsystem: "net.wastu.clipboard", category: "Session")
    ...
    private func pairingInitiatorHandshake(privateKey: Curve25519.KeyAgreement.PrivateKey) throws {
        ...
        // Send KEY_CONFIRM: encrypt "clipboard-paired" with derived key
        let confirmPlaintext = Data("clipboard-paired".utf8)
